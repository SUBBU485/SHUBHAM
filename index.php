...
<nav class="yourart-sidebar yourart-bar-block yourart-black yourart-card yourart-animate-left yourart-hide-medium yourart-hide-large" style="display:none" id="mySidebar">
  ...
  <img src="coverpage.jpg" alt="Nature" class="responsive" height="530">
    <p>REVEALING NEW DESIGNS! AVAIL DISCOUNT BY EARLY GRAB</p>
	<!-- welcome section -->
		...
		<div class="container">
			  <div class="welcome_sec">
				...
				<div class="welcome_sec_about-grids">
				 ...
				 <h4><i><b>What are our goals?</b></i></h4>
                     <p>We aim to collaborate with designers who have good creative skills and can make unique designs which people would love.</p>
				 </div>
				 <div class="col-md-6 welcome_pic">
					 <!--img src="n1.jpg" class="img-responsive" alt=""/-->
                     <p>We want to help them grow by showcasing their skills.</p>
      	...
      	<div class="row">
           ...
           <div style="width:80%;text-align:center">
            ...
            <ul class="agileits_social_list">
									...
									<li><a href="#" class="agile_dribble"><i class="fab fa-dribbble" aria-hidden="true"></i></a></li>
								</ul></div>
            </center>
            </div>
            </div>
